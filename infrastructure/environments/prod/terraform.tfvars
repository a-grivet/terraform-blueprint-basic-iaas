...
environment  = "p"          # Environment name: d (dev), p (prod), s (stage), t (test), c (poc)
...
domain_name = "basic-iaas.your-account-alias.np.org-aws.net" # Your application's domain name (where users access your app)
